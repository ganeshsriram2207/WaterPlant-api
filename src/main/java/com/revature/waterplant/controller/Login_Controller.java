     ...
     public static void main(String[] args) {
       ...
       // testsetavailablecans(); 
        //testavailablecans(); 
         ...
         String validUserJson = Login_Controller.login("ganesh", "popi");
         System.out.println(validUserJson);
         
         System.out.println("Test Case 2: Invalid User");
         String invalidUserJson = Login_Controller.login("1123", "password");
         ...
         public static void testRegister() {
             ...
             System.out.println("Test Case 1: Valid User");
             String validUserJson = Login_Controller.register("priyanka",876543211l,"k@gmail.com","1234");
             System.out.println(validUserJson);
             
             System.out.println("Test Case 2: Invalid User");
             String invalidUserJson = Login_Controller.register("111",765432112,"g22@gmail.com","pop");
             System.out.println(invalidUserJson);
